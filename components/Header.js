    ...
    <div className='fixed top-0 w-full z-30 clearNav md:bg-opacity-90 transition duration-300 ease-in-out'>
      <div className='flex flex-col max-w-6xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8'>
        <div className='flex flex-row items-center justify-between p-4'>
          <div
            className='text-lg font-semibold rounded-lg tracking-widest focus:outline-none focus:shadow-outline cursor-pointer'
            onClick={goToHome}
          >
            <h1 className='text-4xl Avenir tracking-tighter text-gray-900 md:text-4x1 lg:text-3xl'>
              {Data.components.header.company}
            </h1>
          </div>
          <button
              ...
              <li>
                ...
                >
                  <span className='justify-center'>
                    {Data.components.header.contactUs}
                  </span>
                  <svg
